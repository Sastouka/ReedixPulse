# 🏥 ReedixPulse - Système de Gestion pour Centres de Rééducation

**ReedixPulse** est une solution logicielle professionnelle "Local-First" conçue spécifiquement pour les cabinets de kinésithérapie, d'orthophonie, de psychomotricité et tous les centres de rééducation fonctionnant par forfaits de séances.
...
1. Clonez le dépôt :
   ```bash
   git clone [https://github.com/SastoukaDigital/ReedixPulse.git](https://github.com/SastoukaDigital/ReedixPulse.git)
